...
function _isRangeHandleEnabled(gos) {
  ...
  return typeof selection !== "boolean" ? ((_a = selection.handle) == null ? void 0 : _a.mode) === "range" : false;
}
function _isFillHandleEnabled(gos) {
  ...
  return typeof selection !== "boolean" ? ((_a = selection.handle) == null ? void 0 : _a.mode) === "fill" : false;
}
...
var AgColumn = class extends BeanStub {
  ...
  addEventListener(eventType, userListener) {
    ...
    const listener = ((_a = this.frameworkEventListenerService) == null ? void 0 : _a.wrap(userListener)) ?? userListener;
    this.columnEventService.addEventListener(eventType, listener);
  }
  removeEventListener(eventType, userListener) {
    var _a;
    const listener = ((_a = this.frameworkEventListenerService) == null ? void 0 : _a.unwrap(userListener)) ?? userListener;
...
var TooltipFeature = class extends BeanStub {
  ...
  getTooltipParams() {
    ...
    const column = (_a = ctrl.getColumn) == null ? void 0 : _a.call(ctrl);
    const colDef = (_b = ctrl.getColDef) == null ? void 0 : _b.call(ctrl);
    const rowNode = (_c = ctrl.getRowNode) == null ? void 0 : _c.call(ctrl);
    return {
      location: ctrl.getLocation(),
      //'cell',
      colDef,
      column,
      rowIndex: (_d = ctrl.getRowIndex) == null ? void 0 : _d.call(ctrl),
      node: rowNode,
      data: rowNode == null ? void 0 : rowNode.data,
      value: this.getTooltipText(),
      valueFormatted: (_e = ctrl.getValueFormatted) == null ? void 0 : _e.call(ctrl),
      hideTooltipCallback: () => {
        var _a2;
        return (_a2 = this.tooltipManager) == null ? void 0 : _a2.hideTooltip(true);
      }
    };
  }
  getTooltipText() {
...
var AgAbstractInputField = class extends AgAbstractField {
  constructor(config, className, inputType = "text", displayFieldTag = "input") {
    super(
      config,
      (config == null ? void 0 : config.template) ?? /* html */
      `
...
For more info see: https://ag-grid.com/javascript-data-grid/getting-started/#getting-started-with-ag-grid-enterprise`;
      ...
      const modName = (_a = Object.entries(ModuleNames).find(([k, v]) => v === moduleName)) == null ? void 0 : _a[0];
...
var _RowNode = class _RowNode2 {
  ...
  setDataCommon(data, update) {
    ...
    (_a = this.localEventService) == null ? void 0 : _a.dispatchEvent(event);
  }
  ...
  setId(id) {
    ...
    if (getRowIdFunc) {
      if (this.data) {
        const parentKeys = ((_a = this.parent) == null ? void 0 : _a.getRoute()) ?? [];
  ...
  checkAutoHeights() {
    ...
    (_a = rowModel.onRowHeightChangedDebounced) == null ? void 0 : _a.call(rowModel);
  }
  /**
  ...
  dispatchCellChangedEvent(column, newValue, oldValue) {
    ...
    (_a = this.localEventService) == null ? void 0 : _a.dispatchEvent(cellChangedEvent);
  }
  /**
  ...
  dispatchRowEvent(type) {
    var _a;
    (_a = this.localEventService) == null ? void 0 : _a.dispatchEvent({
      type,
      node: this
    });
  }
...
var FilterManager = class extends BeanStub {
  ...
  setFilterModel(model, source = "api") {
    ...
    (_a = this.columnFilterService) == null ? void 0 : _a.setFilterModel(model, source);
  }
  getFilterModel() {
    var _a;
    return ((_a = this.columnFilterService) == null ? void 0 : _a.getFilterModel()) ?? {};
  }
  isColumnFilterPresent() {
    var _a;
    return !!((_a = this.columnFilterService) == null ? void 0 : _a.isColumnFilterPresent());
  }
  isAggregateFilterPresent() {
    var _a;
    return !!((_a = this.columnFilterService) == null ? void 0 : _a.isAggregateFilterPresent());
  }
  isExternalFilterPresent() {
  ...
  onAdvancedFilterEnabledChanged(enabled) {
    var _a, _b;
    if (enabled) {
      if ((_a = this.columnFilterService) == null ? void 0 : _a.disableColumnFilters()) {
        this.onFilterChanged({ source: "advancedFilter" });
      }
    } else {
      if ((_b = this.advancedFilterService) == null ? void 0 : _b.isFilterPresent()) {
  ...
  resetQuickFilterCache() {
    var _a;
    (_a = this.quickFilterService) == null ? void 0 : _a.resetQuickFilterCache();
  }
  ...
  onFilterChanged(params = {}) {
    ...
    (this.columnFilterService ? this.columnFilterService.updateBeforeFilterChanged(params) : AgPromise.resolve()).then(() => {
      ...
      (_a = this.columnFilterService) == null ? void 0 : _a.updateAfterFilterChanged();
    });
  }
  isSuppressFlashingCellsBecauseFiltering() {
    var _a;
    return !!((_a = this.columnFilterService) == null ? void 0 : _a.isSuppressFlashingCellsBecauseFiltering());
  }
  isQuickFilterPresent() {
    var _a;
    return !!((_a = this.quickFilterService) == null ? void 0 : _a.isQuickFilterPresent());
  }
  updateAggFiltering() {
  ...
  isFilterActive(column) {
    var _a;
    return !!((_a = this.columnFilterService) == null ? void 0 : _a.isFilterActive(column));
  }
  getOrCreateFilterWrapper(column) {
    var _a;
    return ((_a = this.columnFilterService) == null ? void 0 : _a.getOrCreateFilterWrapper(column)) ?? null;
  }
  ...
  isFilterAllowed(column) {
    ...
    return !!((_a = this.columnFilterService) == null ? void 0 : _a.isFilterAllowed(column));
  }
  getFloatingFilterCompDetails(column, showParentFilter) {
    var _a;
    return (_a = this.columnFilterService) == null ? void 0 : _a.getFloatingFilterCompDetails(column, showParentFilter);
  }
  getCurrentFloatingFilterParentModel(column) {
    var _a;
    return (_a = this.columnFilterService) == null ? void 0 : _a.getCurrentFloatingFilterParentModel(column);
  }
  // destroys the filter, so it no longer takes part
  destroyFilter(column, source = "api") {
    var _a;
    (_a = this.columnFilterService) == null ? void 0 : _a.destroyFilter(column, source);
  }
  areFilterCompsDifferent(oldCompDetails, newCompDetails) {
    var _a;
    return !!((_a = this.columnFilterService) == null ? void 0 : _a.areFilterCompsDifferent(oldCompDetails, newCompDetails));
  }
  ...
  setAdvancedFilterModel(expression) {
    ...
    if ((_a = this.dataTypeService) == null ? void 0 : _a.isPendingInference()) {
  ...
  hasFloatingFilters() {
    ...
    return !!((_a = this.columnFilterService) == null ? void 0 : _a.hasFloatingFilters());
  }
  getFilterInstance(key, callback) {
    ...
    return (_a = this.columnFilterService) == null ? void 0 : _a.getFilterInstance(key, callback);
  }
  getColumnFilterInstance(key) {
    ...
    return ((_a = this.columnFilterService) == null ? void 0 : _a.getColumnFilterInstance(key)) ?? Promise.resolve(void 0);
  }
  warnAdvancedFilters() {
  ...
  getColumnFilterModel(key) {
    var _a;
    return (_a = this.columnFilterService) == null ? void 0 : _a.getColumnFilterModel(key);
  }
  setColumnFilterModel(key, model) {
    ...
    return ((_a = this.columnFilterService) == null ? void 0 : _a.setColumnFilterModel(key, model)) ?? Promise.resolve();
  }
  setColDefPropertiesForDataType(colDef, dataTypeDefinition, formatValue) {
    var _a;
    (_a = this.columnFilterService) == null ? void 0 : _a.setColDefPropertiesForDataType(colDef, dataTypeDefinition, formatValue);
  }
};
...
var SimpleFilter = class extends ProvidedFilter {
  ...
  shouldRefresh(newParams) {
    ...
    const newOptionsList = ((_a = newParams.filterOptions) == null ? void 0 : _a.map((option) => typeof option === "string" ? option : option.displayKey)) ?? this.getDefaultFilterOptions();
...
function _isEventFromPrintableCharacter(event) {
  ...
  const printableCharacter = ((_a = event.key) == null ? void 0 : _a.length) === 1;
...
var HeaderFilterCellCtrl = class extends AbstractHeaderCellCtrl {
  ...
  setupUserComp() {
    ...
    const compDetails = (_a = this.beans.filterManager) == null ? void 0 : _a.getFloatingFilterCompDetails(
      this.column,
  ...
  updateFilterButton() {
    ...
    if (!this.suppressFilterButton && this.comp) {
      const isFilterAllowed = !!((_a = this.beans.filterManager) == null ? void 0 : _a.isFilterAllowed(this.column));
  ...
  onColDefChanged(compBean) {
    ...
    const newCompDetails = this.active ? (_a = this.beans.filterManager) == null ? void 0 : _a.getFloatingFilterCompDetails(this.column, () => this.showParentFilter()) : null;
    const compPromise = this.comp.getFloatingFilterComp();
    if (!compPromise || !newCompDetails) {
      ...
      compPromise.then((compInstance) => {
        var _a2;
        if (!compInstance || ((_a2 = this.beans.filterManager) == null ? void 0 : _a2.areFilterCompsDifferent(this.userCompDetails ?? null, newCompDetails))) {
          this.updateCompDetails(compBean, newCompDetails, becomeActive);
        } else {
...
function isColumnFilterPresent(beans) {
  var _a, _b;
  return !!((_a = beans.filterManager) == null ? void 0 : _a.isColumnFilterPresent()) || !!((_b = beans.filterManager) == null ? void 0 : _b.isAggregateFilterPresent());
}
function getFilterInstance(beans, key, callback) {
  var _a;
  return (_a = beans.filterManager) == null ? void 0 : _a.getFilterInstance(key, callback);
}
function getColumnFilterInstance(beans, key) {
  var _a;
  return ((_a = beans.filterManager) == null ? void 0 : _a.getColumnFilterInstance(key)) ?? Promise.resolve(void 0);
}
function destroyFilter(beans, key) {
  var _a;
  const column = beans.columnModel.getColDefCol(key);
  if (column) {
    return (_a = beans.filterManager) == null ? void 0 : _a.destroyFilter(column, "api");
  }
}
function setFilterModel(beans, model) {
  beans.frameworkOverrides.wrapIncoming(() => {
    var _a;
    return (_a = beans.filterManager) == null ? void 0 : _a.setFilterModel(model);
  });
}
function getFilterModel(beans) {
  var _a;
  return ((_a = beans.filterManager) == null ? void 0 : _a.getFilterModel()) ?? {};
}
function getColumnFilterModel(beans, column) {
  var _a;
  return ((_a = beans.filterManager) == null ? void 0 : _a.getColumnFilterModel(column)) ?? null;
}
function setColumnFilterModel(beans, column, model) {
  var _a;
  return ((_a = beans.filterManager) == null ? void 0 : _a.setColumnFilterModel(column, model)) ?? Promise.resolve();
}
...
var ColumnFilterService = class extends BeanStub {
  ...
  postConstruct() {
    ...
    this.initialFilterModel = {
      ...((_b = (_a = this.gos.get("initialState")) == null ? void 0 : _a.filter) == null ? void 0 : _b.filterModel) ?? {}
    };
  }
  setFilterModel(model, source = "api") {
    var _a;
    ...
    AgPromise.all(allPromises).then(() => {
      ...
      if (columns.length > 0) {
        (_a2 = this.filterManager) == null ? void 0 : _a2.onFilterChanged({ columns, source });
      }
    });
  }
  ...
  getFilterModel(excludeInitialState) {
    ...
    if (!excludeInitialState) {
      Object.entries(initialFilterModel).forEach(([colId, model]) => {
        var _a;
        if (_exists(model) && !allColumnFilters.has(colId) && ((_a = this.columnModel.getCol(colId)) == null ? void 0 : _a.isFilterAllowed())) {
          result[colId] = model;
        }
      });
    }
  ...
  callOnFilterChangedOutsideRenderCycle(params) {
    const action = () => {
      var _a;
      return (_a = this.filterManager) == null ? void 0 : _a.onFilterChanged(params);
    };
  ...
  getDefaultFilter(column) {
    ...
    if (_isSetFilterByDefault(this.gos)) {
      ...
      const cellDataType = (_a = this.dataTypeService) == null ? void 0 : _a.getBaseDataType(column);
  ...
  onColumnsChanged() {
    ...
    if (columns.length > 0 && !allFiltersAreGroupFilters) {
      (_a = this.filterManager) == null ? void 0 : _a.onFilterChanged({ columns, source: "api" });
    } else {
      this.updateDependentFilters();
    }
  }
  ...
  getFloatingFilterCompDetails(column, showParentFilter) {
    const parentFilterInstance = (callback) => {
      var _a;
      const filterComponent = (_a = this.getOrCreateFilterWrapper(column)) == null ? void 0 : _a.filterPromise;
  ...
  destroyFilter(column, source = "api") {
    ...
    if (filterWrapper) {
      ...
      (_a = this.filterManager) == null ? void 0 : _a.onFilterChanged({
        columns: [column],
        source: "api"
      });
    }
  ...
  getFilterInstanceImpl(key) {
    ...
    const filterPromise = (_a = this.getOrCreateFilterWrapper(column)) == null ? void 0 : _a.filterPromise;
...
function isAnyFilterPresent(beans) {
  var _a;
  return !!((_a = beans.filterManager) == null ? void 0 : _a.isAnyFilterPresent());
}
function onFilterChanged(beans, source = "api") {
  var _a;
  (_a = beans.filterManager) == null ? void 0 : _a.onFilterChanged({ source });
}
...
function isQuickFilterPresent(beans) {
  var _a;
  return !!((_a = beans.filterManager) == null ? void 0 : _a.isQuickFilterPresent());
}
...
function resetQuickFilter(beans) {
  var _a;
  (_a = beans.filterManager) == null ? void 0 : _a.resetQuickFilterCache();
}
var QuickFilterService = class extends BeanStub {
  ...
  refreshQuickFilterCols() {
    ...
    let columnsForQuickFilter = (pivotMode && !this.gos.get("applyQuickFilterBeforePivotOrAgg") ? (_a = this.pivotResultColsService.getPivotResultCols()) == null ? void 0 : _a.list : providedCols) ?? [];
    if (groupAutoCols) {
...
var CheckboxSelectionComponent = class extends Component {
  ...
  showOrHideSelect() {
    ...
    const so = this.gos.get("rowSelection");
    const disableInsteadOfHide = so && typeof so !== "string" ? !_getHideDisabledCheckboxes(so) : (_b = this.column) == null ? void 0 : _b.getColDef().showDisabledCheckboxes;
...
var _CellCtrl = class _CellCtrl2 extends BeanStub {
  ...
  showValue(forceNewCellRendererInstance = false) {
    ...
    let compDetails;
    const isSsrmLoading = rowNode.stub && ((_a = rowNode.groupData) == null ? void 0 : _a[this.column.getId()]) == null;
    if (isSsrmLoading) {
    ...
    animationFrameService.requestAnimationFrame(() => cellRangeFeature == null ? void 0 : cellRangeFeature.refreshHandle());
  }
  setupControlComps() {
    const colDef = this.column.getColDef();
  ...
  setFocusOutOnEditor() {
    ...
    (_a = this.beans.editService) == null ? void 0 : _a.setFocusOutOnEditor(this);
  }
  setFocusInOnEditor() {
    var _a;
    if (!this.editing) {
    ...
    (_a = this.beans.editService) == null ? void 0 : _a.setFocusInOnEditor(this);
  }
  onCellChanged(event) {
  ...
  refreshCell(params) {
    ...
    if (dataNeedsUpdating) {
      ...
      const processingFilterChange = (_a = this.beans.filterManager) == null ? void 0 : _a.isSuppressFlashingCellsBecauseFiltering();
      ...
      (_b = this.cellCustomStyleFeature) == null ? void 0 : _b.applyUserStyles();
      (_c = this.cellCustomStyleFeature) == null ? void 0 : _c.applyClassesFromColDef();
    }
    (_d = this.tooltipFeature) == null ? void 0 : _d.refreshToolTip();
    (_e = this.cellCustomStyleFeature) == null ? void 0 : _e.applyCellClassRules();
  }
  // cell editors call this, when they want to stop for reasons other
  // than what we pick up on. eg selecting from a dropdown ends editing.
  stopEditingAndFocus(suppressNavigateAfterEdit = false, shiftKey = false) {
    var _a;
    (_a = this.beans.editService) == null ? void 0 : _a.stopEditingAndFocus(this, suppressNavigateAfterEdit, shiftKey);
  }
  // user can also call this via API
  flashCell(delays) {
    const flashDuration = (delays == null ? void 0 : delays.flashDuration) ?? (delays == null ? void 0 : delays.flashDelay);
    const fadeDuration = (delays == null ? void 0 : delays.fadeDuration) ?? (delays == null ? void 0 : delays.fadeDelay);
  ...
  onColDefChanged() {
    ...
    if (!this.editing) {
      ...
      (_a = this.beans.editService) == null ? void 0 : _a.handleColDefChanged(this);
    }
  }
  setWrapText() {
...
var _RowCtrl = class _RowCtrl2 extends BeanStub {
  constructor(rowNode, beans, animateIn, useAnimationFrameForCreate, printLayout) {
    ...
    this.gos = beans.gos;
    this.rowNode = rowNode;
    this.paginationPage = ((_a = beans.paginationService) == null ? void 0 : _a.getCurrentPage()) ?? 0;
  ...
  onKeyboardNavigate(keyboardEvent) {
    ...
    const cellPosition = {
      ...
      column: (lastFocusedCell == null ? void 0 : lastFocusedCell.column) ?? this.getColumnForFullWidth(currentFullWidthComp)
    };
  ...
  getRowYPosition() {
    var _a;
    const displayedEl = (_a = this.allRowGuis.find((el) => _isVisible(el.element))) == null ? void 0 : _a.element;
    if (displayedEl) {
  ...
  stopEditing(cancel = false) {
    ...
    (_a = this.beans.rowEditService) == null ? void 0 : _a.stopEditing(this, cancel);
  }
  setInlineEditingCss() {
  ...
  startRowEditing(key = null, sourceRenderedCell = null, event = null) {
    ...
    return ((_a = this.beans.rowEditService) == null ? void 0 : _a.startEditing(this, key, sourceRenderedCell, event)) ?? true;
  }
  getAllCellCtrls() {
  ...
  onPaginationChanged() {
    var _a;
    const currentPage = ((_a = this.beans.paginationService) == null ? void 0 : _a.getCurrentPage()) ?? 0;
  ...
  updateRowIndexes(gui) {
    ...
    const headerRowCount = this.beans.headerNavigationService.getHeaderRowCount() + (((_a = this.beans.filterManager) == null ? void 0 : _a.getHeaderRowCount()) ?? 0);
...
function undoCellEditing(beans) {
  var _a;
  (_a = beans.undoRedoService) == null ? void 0 : _a.undo("api");
}
function redoCellEditing(beans) {
  var _a;
  (_a = beans.undoRedoService) == null ? void 0 : _a.redo("api");
}
...
function getCurrentUndoSize(beans) {
  var _a;
  return ((_a = beans.undoRedoService) == null ? void 0 : _a.getCurrentUndoStackSize()) ?? 0;
}
function getCurrentRedoSize(beans) {
  var _a;
  return ((_a = beans.undoRedoService) == null ? void 0 : _a.getCurrentRedoStackSize()) ?? 0;
}
var EditService = class extends BeanStub {
  ...
  startEditing(cellCtrl, key = null, cellStartedEdit = false, event = null) {
    ...
    return !((_a = compDetails == null ? void 0 : compDetails.params) == null ? void 0 : _a.suppressPreventDefault);
  }
  ...
  setFocusInOnEditor(cellCtrl) {
    ...
    if (cellEditor == null ? void 0 : cellEditor.focusIn) {
      ...
      cellCtrl.onCellEditorAttached(() => {
        var _a, _b;
        return (_b = (_a = cellComp.getCellEditor()) == null ? void 0 : _a.focusIn) == null ? void 0 : _b.call(_a);
      });
    }
  }
...
var TabGuardCtrl = class extends BeanStub {
  ...
  findNextElementOutsideAndFocus(up) {
    ...
    (_a = focusableRange[up ? focusableRange.length - 1 : 0]) == null ? void 0 : _a.focus();
  }
  onFocusIn(e) {
...
var _FocusService = class _FocusService2 extends BeanStub {
  ...
  focusHeaderPosition(params) {
    ...
    if (fromCell && ((_a = this.filterManager) == null ? void 0 : _a.isAdvancedFilterHeaderActive())) {
  ...
  focusProvidedHeaderPosition(params) {
    ...
    if (headerRowIndex === -1) {
      if ((_a = this.filterManager) == null ? void 0 : _a.isAdvancedFilterHeaderActive()) {
        return this.focusAdvancedFilter(headerPosition);
      }
  ...
  focusOverlay(backwards) {
    var _a;
    const overlayGui = this.overlayService.isVisible() && ((_a = this.overlayService.getOverlayWrapper()) == null ? void 0 : _a.getGui());
  ...
  focusGridView(column, backwards = false, canFocusOverlay = true) {
    ...
    if (nextRow) {
      ...
      column ?? (column = (_a = this.getFocusedHeader()) == null ? void 0 : _a.column);
      if (column && rowIndex !== void 0 && rowIndex !== null) {
        this.navigationService.ensureCellVisible({ rowIndex, column, rowPinned });
        if (backwards) {
          const rowCtrl = this.rowRenderer.getRowByPosition(nextRow);
          if ((rowCtrl == null ? void 0 : rowCtrl.isFullWidth()) && this.navigationService.tryToFocusFullWidthRow(nextRow, backwards)) {
            return true;
          }
        }
        this.setFocusedCell({
        ...
        (_b = this.rangeService) == null ? void 0 : _b.setRangeToCell({ rowIndex, rowPinned, column });
        return true;
      }
    }
    if (canFocusOverlay && this.focusOverlay(backwards)) {
  ...
  focusAdvancedFilter(position) {
    ...
    return ((_a = this.advancedFilterService) == null ? void 0 : _a.getCtrl().focusHeaderComp()) ?? false;
  }
  focusNextFromAdvancedFilter(backwards, forceFirstColumn) {
    var _a;
    const column = (forceFirstColumn ? void 0 : this.advancedFilterFocusColumn) ?? ((_a = this.visibleColsService.getAllCols()) == null ? void 0 : _a[0]);
    if (backwards) {
      return this.focusHeaderPosition({
        headerPosition: {
          column,
  ...
  getAlignedGridApis() {
    ...
    const apis = alignedGrids.map((alignedGrid) => {
      ...
      if ("current" in refOrComp) {
        return (_a = refOrComp.current) == null ? void 0 : _a.api;
      }
      if (!refOrComp.api) {
        _errorOnce(
...
var DataTypeService = class extends BeanStub {
  ...
  setColDefPropertiesForBaseDataType(colDef, cellDataType, dataTypeDefinition, colId) {
    ...
    (_a = this.filterManager) == null ? void 0 : _a.setColDefPropertiesForDataType(colDef, dataTypeDefinition, formatValue);
  }
  getDefaultDataTypes() {
...
function getState(beans) {
  var _a;
  return ((_a = beans.stateService) == null ? void 0 : _a.getState()) ?? {};
}
...
var StateService = class extends BeanStub {
  ...
  getFilterState() {
    var _a, _b;
    let filterModel = (_a = this.filterManager) == null ? void 0 : _a.getFilterModel();
    if (filterModel && Object.keys(filterModel).length === 0) {
      filterModel = void 0;
    }
    const advancedFilterModel = ((_b = this.filterManager) == null ? void 0 : _b.getAdvancedFilterModel()) ?? void 0;
  ...
  setFilterState(filterState, gridOptionAdvancedFilterModel) {
    ...
    if (filterModel) {
      (_a = this.filterManager) == null ? void 0 : _a.setFilterModel(filterModel, "columnFilter");
    }
    if (advancedFilterModel) {
      (_b = this.filterManager) == null ? void 0 : _b.setAdvancedFilterModel(advancedFilterModel);
    }
  }
...
function paginationGetPageSize(beans) {
  var _a;
  return ((_a = beans.paginationService) == null ? void 0 : _a.getPageSize()) ?? 100;
}
function paginationGetCurrentPage(beans) {
  var _a;
  return ((_a = beans.paginationService) == null ? void 0 : _a.getCurrentPage()) ?? 0;
}
function paginationGetTotalPages(beans) {
  var _a;
  return ((_a = beans.paginationService) == null ? void 0 : _a.getTotalPages()) ?? 1;
}
...
function paginationGoToNextPage(beans) {
  var _a;
  (_a = beans.paginationService) == null ? void 0 : _a.goToNextPage();
}
function paginationGoToPreviousPage(beans) {
  var _a;
  (_a = beans.paginationService) == null ? void 0 : _a.goToPreviousPage();
}
function paginationGoToFirstPage(beans) {
  var _a;
  (_a = beans.paginationService) == null ? void 0 : _a.goToFirstPage();
}
function paginationGoToLastPage(beans) {
  var _a;
  (_a = beans.paginationService) == null ? void 0 : _a.goToLastPage();
}
function paginationGoToPage(beans, page) {
  var _a;
  (_a = beans.paginationService) == null ? void 0 : _a.goToPage(page);
}
...
var _GridOptionsService = class _GridOptionsService2 extends BeanStub {
  ...
  updateGridOptions({
    ...
    (_a = this.validationService) == null ? void 0 : _a.processGridOptions(this.gridOptions);
...
function onRowHeightChanged(beans) {
  var _a, _b;
  const clientSideRowModel = (_a = beans.rowModelHelperService) == null ? void 0 : _a.getClientSideRowModel();
  const serverSideRowModel = (_b = beans.rowModelHelperService) == null ? void 0 : _b.getServerSideRowModel();
...
function setRowCount(beans, rowCount, maxRowFound) {
  var _a, _b;
  const serverSideRowModel = (_a = beans.rowModelHelperService) == null ? void 0 : _a.getServerSideRowModel();
  ...
  const infiniteRowModel = (_b = beans.rowModelHelperService) == null ? void 0 : _b.getInfiniteRowModel();
  if (infiniteRowModel) {
...
function getCacheBlockState(beans) {
  var _a;
  return ((_a = beans.rowNodeBlockLoader) == null ? void 0 : _a.getBlockState()) ?? {};
}
...
// node_modules/@ag-grid-community/theming/dist/package/main.esm.mjs
var createPartVariant = (part, variant) => new PartImpl(part.feature, variant, part.defaults, part.css);
var customPartCounter = 0;
var createPart = (feature, variant = `customPart${++customPartCounter}`) => new PartImpl(feature, variant);
var PartImpl = class _PartImpl {
  constructor(feature, variant, defaults = {}, css = []) {
  ...
  withParams(params) {
    const newParams = { ...this.defaults };
    for (const [name, value] of Object.entries(params)) {
      if (value != null) {
        newParams[name] = value;
      }
    }
    return new _PartImpl(this.feature, this.variant, newParams, this.css);
  }
  withAdditionalParams(defaults) {
    return this.withParams(defaults);
  }
  withCSS(css) {
    return new _PartImpl(this.feature, this.variant, this.defaults, this.css.concat(css));
  }
};
var coreCSS = (
  /*css*/
...
var getParamType = memoize((param) => {
  ...
  if (/Scale?$/.test(param))
    return "scale";
  if (param === "spacing" || /(Padding|Spacing|Size|Width|Height|Radius|Indent|Start|End|Top|Bottom|Horizontal|Vertical)$/.test(param)) {
    return "length";
  }
  if (/Border$/.test(param))
    return "border";
  if (/BorderStyle$/.test(param))
    return "borderStyle";
  if (/Shadow$/.test(param))
    return "shadow";
  if (/Image$/.test(param))
    return "image";
  if (/Family$/.test(param))
    return "fontFamily";
  if (/Weight$/.test(param))
    return "fontWeight";
  if (/Duration$/.test(param))
    return "duration";
  if (/ColorScheme$/.test(param))
    return "colorScheme";
...
var customThemeCounter = 0;
var createTheme = (id = `customTheme${++customThemeCounter}`) => new ThemeImpl(id, [], {});
var IS_SSR = typeof window !== "object" || !window || typeof document !== "object" || window.document !== document;
var themeClassCounter = 0;
var uninstalledLegacyCSS = false;
var ThemeImpl = class _ThemeImpl {
  constructor(id, dependencies = [], defaults = {}) {
    this.id = id;
  ...
  withParams(params) {
    ...
    return new _ThemeImpl(this.id, this.dependencies, newParams);
  }
  getCSS() {
  ...
  async _install({ container, loadThemeGoogleFonts }) {
    if (IS_SSR)
      return;
...
var getGoogleFontsUsed = (theme) => Array.from(
  new Set(
    Object.values(theme.getParams()).flat().map((value) => value == null ? void 0 : value.googleFont).filter((value) => typeof value === "string")
  )
).sort();
var installCSS = async ({ root, part, scope, css }) => {
...
var uninstallThemeCSS = (scope, root) => {
...
var resolveOnLoad = (element) => new Promise((resolve) => {
  const handler = () => {
...
var checkboxStyleDefault = createPart("checkboxStyle", "default").withAdditionalParams({
...
var colorSchemeLight = createPart("colorScheme", "light");
var colorSchemeLightWarm = createPart("colorScheme", "lightWarm").withParams({
  foregroundColor: "#000000de",
  borderColor: "#60300026",
  chromeBackgroundColor: "#60300005"
});
var colorSchemeLightCold = createPart("colorScheme", "lightCold").withParams({
  foregroundColor: "#000",
  backgroundColor: "#fff",
  chromeBackgroundColor: "#f3f8f8"
});
var colorSchemeDark = createPart("colorScheme", "dark").withParams({
...
var colorSchemeDarkWarm = createPart("colorScheme", "darkWarm").withParams({
...
var colorSchemeDarkBlue = createPart("colorScheme", "darkBlue").withParams({
...
var iconSetAlpine = createPart("iconSet", "alpine").withCSS(iconSetAlpineCSS);
...
var iconSetMaterial = createPart("iconSet", "material").withCSS(iconSetMaterialCSS);
var iconSetQuartzCSS = (
  /*css*/
  `.ag-icon:before{background-color:currentColor;content:"";display:block;height:var(--ag-icon-size);-webkit-mask-image:linear-gradient(#0000,#0000);mask-image:linear-gradient(#0000,#0000);-webkit-mask-size:contain;mask-size:contain;width:var(--ag-icon-size)}`
);
...
var quartzIconSvg = (name, strokeWidth) => {
  const svgFragment = iconNameToSvgFragment[name];
  if (!svgFragment)
    throw new Error(`Missing icon data for ${name}`);
  return `<svg xmlns="http://www.w3.org/2000/svg" class="ag-icon ag-icon-${name}" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke="black" stroke-width="${strokeWidth}" viewBox="0 0 24 24"><style>* { vector-effect: non-scaling-stroke; }</style>` + svgFragment + "</svg>";
};
var iconSetQuartz = (args = {}) => createPart("iconSet", "quartz").withCSS(() => getQuartzIconsCss(args));
var iconSetQuartzLight = createPart("iconSet", "quartzLight").withCSS(() => getQuartzIconsCss({ strokeWidth: 1 }));
var iconSetQuartzRegular = createPart("iconSet", "quartzRegular").withCSS(getQuartzIconsCss);
var iconSetQuartzBold = createPart("iconSet", "quartzBold").withCSS(() => getQuartzIconsCss({ strokeWidth: 2 }));
...
var inputStyleUnderlinedCSS = (
  /*css*/
  `:where(input[class^=ag-]:not([type]),input[class^=ag-][type=text],input[class^=ag-][type=number],input[class^=ag-][type=tel],input[class^=ag-][type=date],input[class^=ag-][type=datetime-local],textarea[class^=ag-]){border-left:none;border-right:none;border-top:none}`
);
var inputStyleBase = createPart("inputStyle", "base").withAdditionalParams({
...
var inputStyleBordered = createPartVariant(inputStyleBase, "bordered").withParams({
...
var inputStyleUnderlined = createPartVariant(inputStyleBase, "underlined").withParams({
  inputBorder: {
    width: 2,
    color: {
      ref: "foregroundColor",
...
var tabStyleBase = createPart("tabStyle", "base").withAdditionalParams({
...
var tabStyleQuartz = createPartVariant(tabStyleBase, "quartz").withParams({
  tabBarBorder: true,
...
var tabStyleMaterial = createPartVariant(tabStyleBase, "material").withParams({
  tabBarBackgroundColor: {
    ref: "chromeBackgroundColor"
  },
...
var tabStyleAlpine = createPartVariant(tabStyleBase, "alpine").withParams({
  tabBarBorder: true,
  tabBarBackgroundColor: {
    ref: "chromeBackgroundColor"
  },
...
var tabStyleRolodex = createPartVariant(tabStyleBase, "rolodex").withParams({
  tabBarBackgroundColor: {
    ref: "chromeBackgroundColor"
  },
...
var createThemeWithDefaultWidgets = (name) => createTheme(name).withPart(checkboxStyleDefault);
var themeQuartz = createThemeWithDefaultWidgets("quartz").withPart(colorSchemeLight).withPart(iconSetQuartz).withPart(tabStyleQuartz).withPart(() => inputStyleBordered).withParams({
  fontFamily: [
...
var themeAlpine = createThemeWithDefaultWidgets("alpine").withPart(colorSchemeLight).withPart(iconSetAlpine).withPart(tabStyleAlpine).withPart(inputStyleBordered).withParams({
  accentColor: "#2196f3",
  selectedRowBackgroundColor: {
    ref: "accentColor",
    mix: 0.3
...
var themeBalham = createThemeWithDefaultWidgets("balham").withPart(colorSchemeLightCold).withPart(iconSetAlpine).withPart(tabStyleRolodex).withPart(inputStyleBordered).withParams({
  spacing: 4,
  borderRadius: 2,
...
//# sourceMappingURL=@ag-grid-community_theming.js.map
