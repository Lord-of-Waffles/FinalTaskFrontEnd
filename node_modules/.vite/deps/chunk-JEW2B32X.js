...
function useMantineColorScheme({ keepTransitions } = {}) {
  const clearStylesRef = (0, import_react26.useRef)();
  const timeoutRef = (0, import_react26.useRef)();
...
function getWithProps(Component) {
  ...
  return (fixedProps) => {
    const Extended = (0, import_react40.forwardRef)((props, ref) => (0, import_jsx_runtime32.jsx)(_Component, { ...fixedProps, ...props, ref }));
...
function factory(ui) {
  ...
  Component.withProps = (fixedProps) => {
    const Extended = (0, import_react40.forwardRef)((props, ref) => (0, import_jsx_runtime32.jsx)(Component, { ...fixedProps, ...props, ref }));
...
function polymorphicFactory(ui) {
  ...
  Component.withProps = (fixedProps) => {
    const Extended = (0, import_react41.forwardRef)((props, ref) => (0, import_jsx_runtime33.jsx)(Component, { ...fixedProps, ...props, ref }));
    Extended.extend = Component.extend;
    Extended.displayName = `WithProps(${Component.displayName})`;
    return Extended;
  };
...
var Thumb = (0, import_react57.forwardRef)((props, forwardedRef) => {
  ...
  const removeUnlinkedScrollListenerRef = (0, import_react57.useRef)();
...
// node_modules/@mantine/core/esm/components/Loader/loaders/Bars.mjs
var Bars = (0, import_react80.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime65.jsxs)(Box, { component: "span", className: clsx_default(classes6.barsLoader, className), ...others, ref, children: [
...
var Dots = (0, import_react81.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime66.jsxs)(Box, { component: "span", className: clsx_default(classes6.dotsLoader, className), ...others, ref, children: [
...
var Oval = (0, import_react82.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime67.jsx)(Box, { component: "span", className: clsx_default(classes6.ovalLoader, className), ...others, ref }));
...
var InputWrapper = factory((_props, ref) => {
  ...
  const _input = (0, import_jsx_runtime89.jsx)(import_react108.Fragment, { children: inputContainer(children) }, "input");
...
var AngleSlider = factory((_props, ref) => {
  ...
  const handleMouseMove = (0, import_react126.useCallback)((event) => {
    update(event);
  }, []);
  const handleMouseUp = (0, import_react126.useCallback)((event) => {
    update(event, true);
    endTracking();
  }, []);
  const handleTouchMove = (0, import_react126.useCallback)((event) => {
    event.preventDefault();
    update(event.touches[0]);
  }, []);
  const handleTouchEnd = (0, import_react126.useCallback)((event) => {
  ...
  const marksItems = marks == null ? void 0 : marks.map((mark, index5) => (0, import_react126.createElement)(
    "div",
    {
...
function useResizing({ transitionDuration, disabled }) {
  const [resizing, setResizing] = (0, import_react142.useState)(true);
  const resizingTimeout = (0, import_react142.useRef)();
  const disabledTimeout = (0, import_react142.useRef)();
  useWindowEvent("resize", () => {
    setResizing(true);
    clearTimeout(resizingTimeout.current);
    resizingTimeout.current = window.setTimeout(
      () => (0, import_react142.startTransition)(() => {
        setResizing(false);
      }),
      200
    );
...
var ComboboxClearButton = (0, import_react147.forwardRef)(
...
function useComboboxTargetProps({
  ...
  const ctx = useComboboxContext();
  const [selectedOptionId, setSelectedOptionId] = (0, import_react151.useState)(null);
  const handleKeyDown = (event) => {
    onKeyDown == null ? void 0 : onKeyDown(event);
    if (ctx.readOnly) {
      return;
...
var ComboboxEventsTarget = factory((props, ref) => {
  ...
  return (0, import_react152.cloneElement)(children, {
    ...targetProps,
    ...others,
...
var ComboboxTarget = factory((props, ref) => {
  ...
  const clonedElement = (0, import_react159.cloneElement)(children, {
    ...targetProps,
    ...others
  });
...
function useCombobox({
  ...
  const listId = (0, import_react160.useRef)(null);
  const selectedOptionIndex = (0, import_react160.useRef)(-1);
  const searchRef = (0, import_react160.useRef)(null);
  const targetRef = (0, import_react160.useRef)(null);
  const focusSearchTimeout = (0, import_react160.useRef)(-1);
  const focusTargetTimeout = (0, import_react160.useRef)(-1);
  const selectedIndexUpdateTimeout = (0, import_react160.useRef)(-1);
  const openDropdown = (0, import_react160.useCallback)(
    (eventSource = "unknown") => {
      if (!dropdownOpened) {
  ...
  const closeDropdown = (0, import_react160.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const toggleDropdown = (0, import_react160.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const clearSelectedItem = (0, import_react160.useCallback)(() => {
  ...
  const selectOption = (0, import_react160.useCallback)(
    (index5) => {
  ...
  const selectActiveOption = (0, import_react160.useCallback)(() => {
  ...
  const selectNextOption = (0, import_react160.useCallback)(
    () => selectOption(
      getNextIndex2(
  ...
  const selectPreviousOption = (0, import_react160.useCallback)(
    () => selectOption(
      getPreviousIndex2(
        selectedOptionIndex.current,
        document.querySelectorAll(`#${listId.current} [data-combobox-option]`),
  ...
  const selectFirstOption = (0, import_react160.useCallback)(
    () => selectOption(
      getFirstIndex(
        document.querySelectorAll(`#${listId.current} [data-combobox-option]`)
      )
  ...
  const updateSelectedOptionIndex = (0, import_react160.useCallback)(
  ...
  const resetSelectedOption = (0, import_react160.useCallback)(() => {
    selectedOptionIndex.current = -1;
    clearSelectedItem();
  }, [clearSelectedItem]);
  const clickSelectedOption = (0, import_react160.useCallback)(() => {
    const items = document.querySelectorAll(
      `#${listId.current} [data-combobox-option]`
    );
  ...
  const setListId = (0, import_react160.useCallback)((id) => {
    listId.current = id;
  }, []);
  const focusSearchInput = (0, import_react160.useCallback)(() => {
    focusSearchTimeout.current = window.setTimeout(() => searchRef.current.focus(), 0);
  }, []);
  const focusTarget = (0, import_react160.useCallback)(() => {
    focusTargetTimeout.current = window.setTimeout(() => targetRef.current.focus(), 0);
  }, []);
  const getSelectedOptionIndex = (0, import_react160.useCallback)(() => selectedOptionIndex.current, []);
...
var InlineInput = (0, import_react162.forwardRef)(
  ({
    __staticSelector,
    __stylesApiProps,
    className,
...
var CheckboxGroupContext = (0, import_react163.createContext)(null);
var CheckboxGroupProvider = CheckboxGroupContext.Provider;
var useCheckboxGroupContext = () => (0, import_react163.useContext)(CheckboxGroupContext);
...
function OptionsDropdown({
  ...
  return (0, import_jsx_runtime149.jsx)(Combobox.Dropdown, { hidden: hidden || hiddenWhenEmpty && isEmpty, children: (0, import_jsx_runtime149.jsxs)(Combobox.Options, { labelledBy: labelId, "aria-label": ariaLabel, children: [
...
var AvatarGroupContext = (0, import_react172.createContext)(null);
var AvatarGroupProvider = AvatarGroupContext.Provider;
function useAvatarGroupContext() {
  const ctx = (0, import_react172.useContext)(AvatarGroupContext);
...
var Avatar = polymorphicFactory((_props, ref) => {
  ...
  const [error2, setError] = (0, import_react174.useState)(!src);
  const getStyles2 = useStyles({
    name: "Avatar",
    props,
    classes: classes28,
  ...
  (0, import_react174.useEffect)(() => setError(!src), [src]);
...
var Breadcrumbs = factory((_props, ref) => {
  ...
  const items = import_react178.Children.toArray(children).reduce((acc, child, index5, array) => {
    var _a;
    const item = isElement(child) ? (0, import_react178.cloneElement)(child, {
      ...getStyles2("breadcrumb", { className: (_a = child.props) == null ? void 0 : _a.className }),
      key: index5
    }) : (0, import_react178.createElement)("div", { ...getStyles2("breadcrumb"), key: index5 }, child);
    acc.push(item);
    if (index5 !== array.length - 1) {
      acc.push(
        (0, import_react178.createElement)(Box, { ...getStyles2("separator"), key: `separator-${index5}` }, separator)
      );
    }
    return acc;
  }, []);
...
var Card = polymorphicFactory((_props, ref) => {
  ...
  const _children = import_react184.Children.toArray(children);
  const content = _children.map((child, index5) => {
    if (typeof child === "object" && child && "type" in child && child.type === CardSection) {
      return (0, import_react184.cloneElement)(child, {
...
var Thumb2 = (0, import_react192.forwardRef)(({ position, ...others }, ref) => (0, import_jsx_runtime171.jsx)(
  Box,
  {
    ref,
    __vars: {
...
var ColorSlider = factory((_props, ref) => {
  ...
  const theme = useMantineTheme();
  const [position, setPosition] = (0, import_react193.useState)({ y: 0, x: value / maxValue });
  ...
  const layers = overlays.map((overlay, index5) => (0, import_react193.createElement)("div", { ...getStyles2("sliderOverlay"), style: overlay, key: index5 }));
...
// node_modules/@mantine/core/esm/components/ColorPicker/AlphaSlider/AlphaSlider.mjs
var defaultProps78 = {};
var AlphaSlider = (0, import_react194.forwardRef)((props, ref) => {
...
var HueSlider = (0, import_react195.forwardRef)((props, ref) => {
...
function Saturation({
  ...
  const [position, setPosition] = (0, import_react196.useState)({ x: value.s / 100, y: 1 - value.v / 100 });
...
var Swatches = (0, import_react197.forwardRef)(
  ({
    className,
    datatype,
    setValue,
    ...
    const colors = data.map((color, index5) => (0, import_react197.createElement)(
      ColorSwatch,
      {
...
var ColorPicker = factory((_props, ref) => {
  ...
  const formatRef = (0, import_react198.useRef)(format2);
  const valueRef = (0, import_react198.useRef)();
  const scrubTimeoutRef = (0, import_react198.useRef)(-1);
  const isScrubbingRef = (0, import_react198.useRef)(false);
  ...
  const [parsed, setParsed] = (0, import_react198.useState)(parseColor(_value));
...
var ColorInput = factory((_props, ref) => {
  ...
  const [dropdownOpened, setDropdownOpened] = (0, import_react199.useState)(false);
  const [lastValidValue, setLastValidValue] = (0, import_react199.useState)("");
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: "",
...
function useVirtualizedCombobox({
  ...
  const listId = (0, import_react200.useRef)(null);
  const searchRef = (0, import_react200.useRef)(null);
  const targetRef = (0, import_react200.useRef)(null);
  const focusSearchTimeout = (0, import_react200.useRef)(-1);
  const focusTargetTimeout = (0, import_react200.useRef)(-1);
  const openDropdown = () => {
    if (!dropdownOpened) {
      setDropdownOpened(true);
  ...
  const getSelectedOptionIndex = (0, import_react200.useCallback)(() => selectedOptionIndex, []);
  return {
    dropdownOpened,
    openDropdown,
    closeDropdown,
...
function DrawerStack({ children }) {
  const [stack, setStack] = (0, import_react212.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react212.useState)(getDefaultZIndex("modal"));
...
var FileButton = (0, import_react216.forwardRef)(
  (props, ref) => {
    const {
      onChange,
      children,
    ...
    const inputRef = (0, import_react216.useRef)();
    const onClick = () => {
      var _a;
...
var _FileInput = factory((_props, ref) => {
  ...
  const resetRef = (0, import_react217.useRef)(null);
  const { resolvedClassNames, resolvedStyles } = useResolvedStylesApi({
    classNames,
    styles,
    props
...
function useDelayedHover({ open, close, openDelay, closeDelay }) {
  const openTimeout = (0, import_react218.useRef)(-1);
  const closeTimeout = (0, import_react218.useRef)(-1);
  const clearTimeouts = () => {
  ...
  (0, import_react218.useEffect)(() => clearTimeouts, []);
...
var HoverCardTarget = (0, import_react229.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime207.jsx)(Popover.Target, { refProp, ref, ...others, children: (0, import_react229.cloneElement)(
    children,
...
var Image = polymorphicFactory((_props, ref) => {
  ...
  const [error2, setError] = (0, import_react232.useState)(!src);
  (0, import_react232.useEffect)(() => setError(!src), [src]);
  const getStyles2 = useStyles({
    name: "Image",
    classes: classes49,
    props,
...
var index3 = import_react235.useLayoutEffect;
...
var useComposedRef = function useComposedRef2(libRef, userRef) {
  var prevUserRef = (0, import_react236.useRef)();
  return (0, import_react236.useCallback)(function(instance) {
...
var JsonInput = factory((props, ref) => {
  ...
  const [valid, setValid] = (0, import_react238.useState)(validateJson(_value, deserialize));
...
var LoadingOverlay = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime218.jsx)(Transition, { transition: "fade", ...transitionProps, mounted: !!visible, children: (transitionStyles) => (0, import_jsx_runtime218.jsxs)(Box, { ...getStyles2("root", { style: transitionStyles }), ref, ...others, children: [
...
var MenuDropdown = factory((props, ref) => {
  ...
  const wrapperRef = (0, import_react246.useRef)(null);
  const ctx = useMenuContext();
...
var MenuItem = polymorphicFactory((props, ref) => {
  ...
  const theme = useMantineTheme();
  const { dir } = useDirection();
  const itemRef = (0, import_react247.useRef)();
...
var MenuTarget = (0, import_react249.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime224.jsx)(Popover.Target, { refProp, popupType: "menu", ref, ...others, children: (0, import_react249.cloneElement)(children, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
function Menu(_props) {
  ...
  const [openedViaClick, setOpenedViaClick] = (0, import_react250.useState)(false);
  const close = () => {
    setOpened(false);
...
function ModalStack({ children }) {
  const [stack, setStack] = (0, import_react259.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react259.useState)(getDefaultZIndex("modal"));
...
function useModalsStack(modals) {
  ...
  const [state, setState] = (0, import_react262.useState)(initialState);
  const open = (0, import_react262.useCallback)((modal) => {
    setState((current) => ({ ...current, [modal]: true }));
  }, []);
  const close = (0, import_react262.useCallback)(
    (modal) => setState((current) => ({ ...current, [modal]: false })),
    []
  );
  const toggle = (0, import_react262.useCallback)(
    (modal) => setState((current) => ({ ...current, [modal]: !current[modal] })),
    []
  );
  const closeAll = (0, import_react262.useCallback)(() => setState(initialState), []);
  const register = (0, import_react262.useCallback)(
    (modal) => ({
      opened: state[modal],
      onClose: () => close(modal),
      stackId: modal
...
function usePersistentCallback(cb) {
  var callbackRef = (0, import_react274.useRef)(cb);
  callbackRef.current = cb;
  var persistentCbRef = (0, import_react274.useRef)(function() {
    var args = [], len = arguments.length;
    while (len--) args[len] = arguments[len];
...
function useInternalValues(value, defaultValue, valueIsNumericString, format2, removeFormatting2, onValueChange) {
  ...
  (0, import_react274.useMemo)(function() {
    setValues(newValues);
...
function NumberFormatBase(props) {
  ...
  var caretPositionBeforeChange = (0, import_react274.useRef)();
  var lastUpdatedValue = (0, import_react274.useRef)({ formattedValue, numAsString });
  ...
  var ref$1 = (0, import_react274.useState)(false);
  var mounted = ref$1[0];
  var setMounted = ref$1[1];
  var focusedElm = (0, import_react274.useRef)(null);
  var timeout = (0, import_react274.useRef)({
  ...
  var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? import_react274.useLayoutEffect : import_react274.useEffect;
  ...
  if (displayType === "text") {
    return renderText ? import_react274.default.createElement(import_react274.default.Fragment, null, renderText(formattedValue, otherProps) || null) : import_react274.default.createElement("span", Object.assign({}, otherProps, { ref: getInputRef }), formattedValue);
  } else if (customInput) {
    var CustomInput = customInput;
    return import_react274.default.createElement(CustomInput, Object.assign({}, inputProps, { ref: getInputRef }));
  }
  return import_react274.default.createElement("input", Object.assign({}, inputProps, { ref: getInputRef }));
}
...
function NumericFormat(props) {
  ...
  return import_react274.default.createElement(NumberFormatBase, Object.assign({}, numericFormatProps));
}
...
var NumberInput = factory((_props, ref) => {
  ...
  const onStepTimeoutRef = (0, import_react276.useRef)(null);
  const stepCountRef = (0, import_react276.useRef)(0);
  ...
  const incrementRef = (0, import_react276.useRef)();
  ...
  const decrementRef = (0, import_react276.useRef)();
  ...
  return (0, import_jsx_runtime261.jsxs)(import_jsx_runtime261.Fragment, { children: [
    (0, import_jsx_runtime261.jsx)(
      Group,
      {
        ...
        __size: size4,
        dir: "ltr",
        children: _value.map((char, index5) => (0, import_react284.createElement)(
          Input,
          {
            component: "input",
            ...getStyles2("pinInput", {
...
function useFloatingTooltip({
  ...
  const [opened, setOpened] = (0, import_react300.useState)(defaultOpened);
...
function useTooltip(settings) {
  var _a, _b, _c;
  const [uncontrolledOpened, setUncontrolledOpened] = (0, import_react306.useState)(settings.defaultOpened);
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset4 }, index5) => (0, import_react311.createElement)(
    Curve,
    {
      ...data,
      key: index5,
...
var SegmentedControl = factory((_props, ref) => {
  ...
  const [parent, setParent] = (0, import_react312.useState)(null);
  const [refs, setRefs] = (0, import_react312.useState)({});
  ...
  const controls = _data.map((item) => (0, import_react312.createElement)(
    Box,
    {
      ...getStyles2("control"),
    ...
    (0, import_react312.createElement)(
      "input",
      {
        ...getStyles2("input"),
...
var Skeleton = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime289.jsx)(Box, { ref, ...getStyles2("root"), mod: [{ visible, animate }, mod], ...others });
});
...
var SliderRoot = (0, import_react319.forwardRef)(
...
var Thumb3 = (0, import_react320.forwardRef)(
  ({
    max: max2,
    min: min2,
    value,
    ...
    const { getStyles: getStyles2 } = useSliderContext();
    const [focused, setFocused] = (0, import_react320.useState)(false);
...
function Marks({ marks, min: min2, max: max2, disabled, value, offset: offset4, inverted }) {
  ...
  const items = marks.map((mark, index5) => (0, import_react321.createElement)(
    Box,
    {
...
var Slider = factory((_props, ref) => {
  ...
  const root = (0, import_react323.useRef)();
  const thumb = (0, import_react323.useRef)();
  const position = getPosition({ value: _value, min: min2, max: max2 });
  const scaledValue = scale(_value);
  const _label = typeof label === "function" ? label(scaledValue) : label;
  const precision = _precision ?? getPrecision(step);
  const handleChange = (0, import_react323.useCallback)(
    ({ x }) => {
      if (!disabled) {
...
var RangeSlider = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const [focused, setFocused] = (0, import_react324.useState)(-1);
  const [hovered, setHovered] = (0, import_react324.useState)(false);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
  ...
  const valueRef = (0, import_react324.useRef)(_value);
  const thumbs = (0, import_react324.useRef)([]);
  const thumbIndex = (0, import_react324.useRef)(void 0);
  const positions = [
...
var Stepper = factory((_props, ref) => {
  ...
  const convertedChildren = import_react330.Children.toArray(children);
  ...
  const items = _children.reduce((acc, item, index5) => {
    ...
    acc.push(
      (0, import_react330.cloneElement)(item, {
    ...
    if (orientation === "horizontal" && index5 !== _children.length - 1) {
      acc.push(
        (0, import_react330.createElement)(
          "div",
          {
...
var SwitchGroupContext = (0, import_react331.createContext)(null);
var SwitchGroupProvider = SwitchGroupContext.Provider;
var useSwitchGroupContext = () => (0, import_react331.useContext)(SwitchGroupContext);
...
function TreeNode({
  ...
  const ref = (0, import_react352.useRef)(null);
...
function useTree({
  ...
  const [data, setData] = (0, import_react355.useState)([]);
  const [expandedState, setExpandedState] = (0, import_react355.useState)(initialExpandedState);
  const [selectedState, setSelectedState] = (0, import_react355.useState)(initialSelectedState);
  const [checkedState, setCheckedState] = (0, import_react355.useState)(initialCheckedState);
  const [anchorNode, setAnchorNode] = (0, import_react355.useState)(null);
  const [hoveredNode, setHoveredNode] = (0, import_react355.useState)(null);
  const initialize = (0, import_react355.useCallback)(
    (_data) => {
  ...
  const toggleExpanded = (0, import_react355.useCallback)(
    (value) => {
  ...
  const collapse = (0, import_react355.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expand = (0, import_react355.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expandAllNodes = (0, import_react355.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
  ...
  const collapseAllNodes = (0, import_react355.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
      Object.keys(next).forEach((key) => {
        next[key] = false;
  ...
  const toggleSelected = (0, import_react355.useCallback)(
  ...
  const select = (0, import_react355.useCallback)((value) => {
    setAnchorNode(value);
    setSelectedState(
      (current) => multiple ? current.includes(value) ? current : [...current, value] : [value]
    );
  }, []);
  const deselect = (0, import_react355.useCallback)((value) => {
    anchorNode === value && setAnchorNode(null);
    setSelectedState((current) => current.filter((item) => item !== value));
  }, []);
  const clearSelected = (0, import_react355.useCallback)(() => {
    setSelectedState([]);
    setAnchorNode(null);
  }, []);
  const checkNode = (0, import_react355.useCallback)(
    (value) => {
  ...
  const uncheckNode = (0, import_react355.useCallback)(
    (value) => {
      const checkedNodes = getChildrenNodesValues(value, data);
  ...
  const checkAllNodes = (0, import_react355.useCallback)(() => {
    setCheckedState(() => getAllChildrenNodes(data));
  }, [data]);
  const uncheckAllNodes = (0, import_react355.useCallback)(() => {
    setCheckedState([]);
  }, []);
...
var Tree = factory((_props, ref) => {
  ...
  const flatValues = (0, import_react356.useMemo)(() => getFlatValues(data), [data]);
...
tabbable/dist/index.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-JEW2B32X.js.map
